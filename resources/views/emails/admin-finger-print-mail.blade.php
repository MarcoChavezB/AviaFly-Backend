<!-- resources/views/emails/admin-entry-notification.blade.php -->
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        <div class="header">
            <h1>Notificación de Registro de Entrada Administracion</h1>
        </div>
        <div class="content">
            <p>Se ha registrado una entrada de un empleado.</p>
